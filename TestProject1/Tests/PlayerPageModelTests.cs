...
namespace FantasyCricketApp.Tests
{
    ...
    public class PlayerPageModelTests
    {
        ...
        public void ResetRepository()
        {
            ...
            list.Clear();
            list.Add(new Player { Id = 1, Name = "Virat Kohli", Team = "UPI", Role = "User", Price = 7.0M });
            list.Add(new Player { Id = 2, Name = "Jasprit Bumrah", Team = "Net Banking", Role = "Admin", Price = 8.5M });
        }
